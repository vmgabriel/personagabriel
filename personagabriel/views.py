...
class SteresCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("personagabriels:steress")
...
def delete_steres_view(request, pk):
    ...
    steres.delete()
    return redirect("personagabriels:steress")
...
class UserCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("personagabriels:users")
...
def delete_user_view(request, pk):
    ...
    user.delete()
    return redirect("personagabriels:users")
...
class PreductsCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("personagabriels:preductss")
...
def delete_preducts_view(request, pk):
    ...
    preducts.delete()
    return redirect("personagabriels:preductss")
...
class SheppingcartCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("personagabriels:sheppingcarts")
...
def delete_sheppingcart_view(request, pk):
    ...
    sheppingcart.delete()
    return redirect("personagabriels:sheppingcarts")
